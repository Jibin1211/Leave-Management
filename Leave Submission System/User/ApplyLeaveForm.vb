...
Public Class ApplyLeaveForm
    ...
    Private Sub Submitbtn_Click(sender As Object, e As EventArgs) Handles Submitbtn.Click
        ...
        If String.IsNullOrWhiteSpace(ReasonBox.Text) OrElse Leavetypebox.SelectedIndex = -1 Then
        ...
        Else
            Try
                ...
                Dim sqlInsert As String = "INSERT INTO Leave_Info (username, leave_ID, leave_type, from_date, to_date, no_of_days, reason, leave_status, applied_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);"
                Using commandInsert As New OleDbCommand(sqlInsert, conn)
                    ...
                    commandInsert.Parameters.AddWithValue("@applied_date", DateTime.Today.ToString("yyyy-MM-dd"))
                    conn.Open()
