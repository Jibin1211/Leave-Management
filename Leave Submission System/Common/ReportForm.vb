...
Public Class ReportForm
    ...
    Private Sub LoadReport()
        Try
            ...
            Dim sql As String = "SELECT Leave_Info.leave_ID, Leave_Info.username, User_Details.firstname, User_Details.lastname, Leave_Info.leave_type, Leave_Info.from_date, Leave_Info.no_of_days, Leave_Info.leave_status, Leave_Info.applied_date FROM Leave_Info ,User_Details where Leave_Info.username=User_Details.username"
            ...
            reportleave.Columns("applied_date").HeaderText = "Applied Date"
        Catch ex As Exception
            MessageBox.Show("An error occurred: " & ex.Message)
        End Try
    End Sub
            ...
            If mRow < reportleave.Rows.Count Then
                ...
                For Each cell As DataGridViewCell In row.Cells
                    If cell.Visible Then
                        rc = New Rectangle(x, y, 120, cell.Size.Height)
